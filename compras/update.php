                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <script>
                                                                                $('#btn_selecionar<?php echo $id_producto;?>').click(function () {
                                                                                    ...
                                                                                    var stock_maxino = "<?php echo $productos_dato['stock_maxino'];?>";
                                                                                    $('#stock_maxino').val(stock_maxino);
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="<?= $stock_maxino; ?>" name="stock_maxino" id="stock_maxino" class="form-control" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
